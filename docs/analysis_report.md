...
KPConv, как представитель классического point-based подхода, показал наиболее скромные результаты.

*   **Общие наблюдения:** Модель хорошо справляется с определением стульев и кресел, но показывает низкое качество на остальных объектах.
*   **Сильные стороны:** Уверенное распознавание мебели для сидения.
*   **Слабые стороны:**
    *   Пол сегментирован корректно лишь на ~60%. Стены и дверь определены плохо.
