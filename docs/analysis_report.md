...
Входные данные представляют собой облака точек из одной и той же комнаты, полученные с лидара Leica BLK360 в формате .pcd. Это позволяет сравнивать влияние предобработки на качество сегментации.
